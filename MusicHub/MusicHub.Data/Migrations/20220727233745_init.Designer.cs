...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicHub.Data.Models.SongPreformer", b =>
                {
                    b.Property<int>("SongId")
                        .HasColumnType("int");

                    b.Property<int>("PreformerId")
                        .HasColumnType("int");

                    b.HasKey("SongId", "PreformerId");

                    b.HasIndex("PreformerId");

                    b.ToTable("SongPreformers");
                });
            ...
            modelBuilder.Entity("MusicHub.Data.Models.SongPreformer", b =>
                {
                    b.HasOne("MusicHub.Data.Models.Performer", "preformer")
                        .WithMany("PreformerSong")
                        .HasForeignKey("PreformerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MusicHub.Data.Models.Song", "song")
                        .WithMany("SongPreformers")
