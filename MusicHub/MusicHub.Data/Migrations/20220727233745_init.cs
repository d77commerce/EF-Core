        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreformerId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SongPreformers", x => new { x.SongId, x.PreformerId });
                    table.ForeignKey(
                        name: "FK_SongPreformers_Performers_PreformerId",
                        column: x => x.PreformerId,
                        principalTable: "Performers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SongPreformers_Songs_SongId",
                        column: x => x.SongId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SongPreformers_PreformerId",
                table: "SongPreformers",
                column: "PreformerId");
